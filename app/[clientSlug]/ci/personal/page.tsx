...
function StaticPersonalEmail() {
  return (
    <div className="space-y-6 px-4 py-6 pointer-events-none select-none" aria-hidden="true">
      <div>
        <h1 className="text-3xl font-bold">Personal Email</h1>
        <p className="text-muted-foreground mt-1">Emails from seed accounts assigned to your organization appear here.</p>
      </div>
          ...
          <div className="absolute inset-0 z-10 flex min-h-[60vh] items-center justify-center bg-background/70 backdrop-blur-sm">
            <div className="max-w-md w-full mx-4 rounded-xl border-2 border-[#dc2a28]/20 bg-card shadow-2xl p-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-bold">Personal Email is a Paid Feature</h2>
                <p className="text-muted-foreground text-sm">
                  Upgrade your plan to receive emails directly to seed accounts assigned to your organization.
                </p>
              </div>
              <ul className="text-sm text-left space-y-2">
                {[
                  "Dedicated seed email accounts for your org",
                  "See exactly what lands in your inbox vs. spam",

...
export async function POST(request: NextRequest) {
  try {
    ...
    // Only owners and admins can request email seeds
      ...
      <html>
        <head>
          <style>
            ...
            .highlight { background: #d1fae5; border: 1px solid #6ee7b7; border-radius: 6px; padding: 16px; margin: 16px 0; }
        ...
        <body>
          <div class="container">
            <div class="header">
              <h2 style="margin:0">Email Seed Request</h2>
              <p style="margin:4px 0 0; opacity:0.8; font-size:14px">A new email seed account request has been submitted.</p>
            </div>
            <div class="body">
              <div class="detail">
              ...
              <div class="detail">
                <div class="label">Email Seeds Requested</div>
                <div class="value">${quantity} seed email${quantity > 1 ? "s" : ""}</div>
              </div>
              <div class="highlight">
                <strong>Action Required:</strong> Assign ${quantity} seed email account${quantity > 1 ? "s" : ""} to ${clientName}. This is included in their current plan — no billing change required.
              </div>
              <div class="footer">
    ...
    formData.append("subject", `Email Seed Request: ${clientName} wants ${quantity} seed${quantity > 1 ? "s" : ""}`)
    ...
    console.error("Error processing email seed request:", error)

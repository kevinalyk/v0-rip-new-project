      ...
      <html>
        <head>
          <style>
            ...
            .button { display: inline-block; padding: 12px 24px; background-color: #e63946; color: #000000; text-decoration: none; border-radius: 5px; margin: 20px 0; font-weight: 600; }

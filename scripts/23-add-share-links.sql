-- Add share link functionality to CompetitiveInsightCampaign
...
CREATE INDEX IF NOT EXISTS "CompetitiveInsightCampaign_shareToken_idx" ON "CompetitiveInsightCampaign"("shareToken");
